...
class VehicleState
{
    ...
    void ComputeSlope();
    void GetAllData(double goal_id,double preview_id,const ControlConf &control_conf,const double computational_time,const double average_time,const double max_time);
    ...
    double distance_difference_threshold=0.3;
    double lateral_distance_error=0.0;
    double last_lateral_distance_error=0.0;
    double average_lateral_distance_error=0.0;
    double max_lateral_distance_error=0.0;
    
    double velocity_difference_threshold=0.5;
    double velocity_error=0.0;
    double last_velocity_error=0.0;
    double average_velocity_error=0.0;
    double max_velocity_error=0.0;
    
    double heading_difference_threshold=0.3;
